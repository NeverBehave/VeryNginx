...
def install_openresty( ):
    ...
    exec_sys_cmd( './configure --prefix=/opt/verynginx/openresty --user=nobody --group=nobody --with-http_v2_module --with-http_sub_module --with-http_stub_status_module --with-luajit' )
